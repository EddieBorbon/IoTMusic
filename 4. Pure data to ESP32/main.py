...
def serverThread():
    ...
    pwm = PWM(Pin(12))
    pwm.duty(600)  # Configura el ciclo de trabajo del PWM para el servo motor
    ...
    while True:
        ...
        # Para mover el servo motor, convierte el valor recibido en un valor para el ciclo de trabajo
        # (Este código asume que el rango de valores es 0-1023)
        pwm.duty(data)

# Inicia el hilo del servidor para recibir datos y controlar el servo motor
